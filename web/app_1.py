...
if not os.path.exists(SPEECH_RESULT_FOLDER):
    os.makedirs(SPEECH_RESULT_FOLDER) 
    
if not os.path.exists(SUMIT_FOLDER):
    os.makedirs(SUMIT_FOLDER) 
    
if not os.path.exists(EMOTION_RESULT_FOLDER):
    os.makedirs(EMOTION_RESULT_FOLDER)
